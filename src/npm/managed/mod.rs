...
use lib_node_resolver::errors::PackageFolderResolveError;
use lib_node_resolver::errors::PackageFolderResolveIoError;
...
fn npm_process_state(
    ...
    serde_json::to_string(&NpmProcessState {
        ...
        local_node_modules_path: node_modules_path.map(|p| p.to_string_lossy().to_string()),
    })
    .unwrap()
}
