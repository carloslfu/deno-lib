...
struct SharedWorkerState {
    ...
    // otel_config: None, // `None` means OpenTelemetry is disabled.
}
...
impl CliMainWorkerFactory {
    ...
    pub async fn create_custom_worker(
        ...
        let mut unstable_features = Vec::with_capacity(crate::UNSTABLE_GRANULAR_FLAGS.len());
    ...
    fn resolve_binary_entrypoint(
            ...
            .resolve_binary_export(package_folder, sub_path)
        {
            ...
            Err(original_err) => {
                ...
                let result = self.resolve_binary_entrypoint_fallback(package_folder, sub_path);
                match result {
